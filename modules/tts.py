    ...
    def __init__(self, pub_exchanges=["tts"], sub_exchanges=["dialogue"]):
        ...
        if self.engine_name == "azure":
            ...
            with tempfile.NamedTemporaryFile() as temp_file:
                ...
                voice_style: str = self.tts_style
                ssml_text: str = f"""
    ...
    def synthesis_loop(self):
        while True:
            ...
            if isinstance(output_text, dict):
                tts_style = output_text["tts_style"]
                if tts_style in ["chat", "cheerful", "customerservice"]:
            ...
            if output_text != "":
                ...
                if self.engine_name == "azure":
                    ...
                    sys.stderr.write("Currently, azure is acceptable as a tts engine.")
